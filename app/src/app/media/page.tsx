      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden" style={{ background: "rgba(9, 9, 11, 0.3)" }}>
        ...
        <div className="flex-1 flex items-center justify-center p-6 relative select-none overflow-hidden bg-background/10">
          {hasNoItems ? (
            ...
            <div className="flex flex-col items-center text-center p-12 max-w-sm rounded-3xl border border-white/[0.04] bg-background/20 backdrop-blur-xl animate-fade-in shadow-xl">
              <div className="w-12 h-12 rounded-full flex items-center justify-center bg-accent/10 text-accent border border-accent/20 mb-4">
                <CheckCircle size={24} />
              </div>
              ...
              <button
                ...
                className="mt-5 px-4 py-2 bg-accent hover:bg-accent-hover text-black text-[11px] font-bold rounded-xl cursor-pointer shadow-md transition-all duration-150"
              >
                Review Cohort Again
              </button>
            </div>
                ...
                <div className="flex-[3] flex flex-col justify-between items-center gap-4 overflow-hidden">
                  ...
                  >
                    ...
                    <div className="flex-1 w-full h-full relative overflow-hidden bg-black flex items-center justify-center p-2">
                      ...
                      {isSwiping && (swipeDirection === "right") && (
                        <div className="absolute inset-0 bg-accent/10 flex items-center justify-center text-accent font-bold border border-accent/30 rounded-3xl animate-pulse">
                  ...
                  <div className="w-full shrink-0 space-y-1.5 px-1">
                    ...
                    <div className="w-full h-1 rounded-full bg-surface border border-white/[0.02] overflow-hidden">
                      <div 
                        className="h-full bg-accent transition-all duration-300 rounded-full shadow-[0_0_8px_rgba(16,185,129,0.3)]"
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-10 bg-background/20" id="scrapbook-scroll-pane">
          ...
          <div className="flex items-center justify-between pb-6 border-b border-white/[0.04]">
            ...
            <button
              ...
              className="px-3.5 py-1.5 bg-gradient-to-r from-accent to-teal-500 hover:from-accent-hover hover:to-teal-600 text-[11px] font-bold text-white rounded-xl transition-all shadow-sm flex items-center gap-1.5"
            >
              Print Memoir Book
            </button>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-[14px] font-bold text-accent flex items-center gap-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-2">
                      <input 
                        ...
                        className="flex-1 text-[12px] px-3.5 py-2 rounded-xl focus:outline-none focus:ring-1 focus:ring-accent/20 font-semibold"
                        style={{ 
                  ...
                  {day.narrative?.ai_narrative && (
                    <div className="p-4 rounded-xl border border-accent/5 bg-accent/5 space-y-2">
                      <span className="text-[9px] font-bold text-accent uppercase tracking-widest block">memoir chapter prose</span>
                      <p className="text-[12px] font-serif leading-relaxed text-text-secondary first-letter:text-2xl first-letter:font-bold first-letter:text-accent first-letter:mr-2 first-letter:float-left">
                        {day.narrative.ai_narrative}
                      </p>
                    </div>
                  )}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea 
                      ...
                      rows={2}
                      className="w-full text-[12px] px-3.5 py-2 rounded-xl focus:outline-none focus:ring-1 focus:ring-accent/20 font-semibold resize-none"
                      style={{ 
                        background: "rgba(24, 24, 27, 0.6)", 
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-surface-elevated hover:bg-surface-elevated border border-white/[0.04] text-[10px] font-bold text-accent hover:text-accent rounded-xl transition-all shadow-sm cursor-pointer disabled:opacity-40"
                    >
