      ...
      const starterNotes = [
        {
          ...
          content: "We must build high-fidelity voice interfaces locally. All voice recordings should stay on your own machine, with Whisper running locally. No subscriptions, no telemetry.",
          tags: ["Idea", "Design"]
        },
        {
