...
Keep PRs focused. Run `npm run lint` and confirm `npm run build` passes before opening. Describe what changed and why, and reference the part of the vision it serves.
