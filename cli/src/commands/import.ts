...
const IMPORTER_MAP: Record<string, string> = {
  ...
  chatgpt: "import-chatgpt.ts",
  claude: "import-claude.ts",
  calendar: "import-calendar.ts",
  contacts: "import-contacts.ts",
  browser: "import-browser.ts",
  bookmarks: "import-bookmarks.ts",
  todoist: "import-todoist.ts",
};
